...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link rel="icon" href="{{ asset('public/img/fetalcare.ico') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/meta.css?v='.$version) }} "/>


    <title>FETALCARE - Inicio Sessión</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              ...
              <img src="{{ asset('public/img/fetalcare.jpg') }}" alt="logo" width="180" height="130" class="logo-img">
