	...
	<div class="linea">
		<div class="linea_izq">
			<strong>ASEGUR.:</strong>  {{$paciente->apellido_paterno}} {{$paciente->apellido_materno}} {{$paciente->nombres}}
		</div>
		<div class="linea_der">
	...
	<div class="linea">
		...
		<div class="linea_der">
			<strong>VIGENCIA  :</strong> {{date('Y-m-d',strtotime($funcion->fechaactual)) }} años
		</div>
	</div>
	<br>	
	{{-- <hr  class="borde_med" width="340px"> --}}
