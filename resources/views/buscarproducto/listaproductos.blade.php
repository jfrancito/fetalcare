            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Productos
                  <div class="tools">
                    <a href="{{ url('/agregar-producto/'.$idopcion) }}" data-toggle="tooltip" data-placement="top" title="Crear Producto">
                            ...
                            <td class="rigth">
                              <div class="btn-group btn-hspace">
                                ...
                                <ul role="menu" class="dropdown-menu pull-right">
                                  <li>
                                    <a href="{{ url('/modificar-producto/'.$idopcion.'/'.Hashids::encode(substr($item->id, -8))) }}">
                                      Modificar
                                    </a>
                                  </li>
                                </ul>
