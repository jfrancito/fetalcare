    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Producto<span class="panel-subtitle">Crear un nuevo Producto</span></div>
          <div class="panel-body">
            <form method="POST" action="{{ url('/agregar-producto/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <input  type="text"
                          id="unidad" name='unidad' value="{{ old('unidad') }}" placeholder="Unidad Medida"
                          required = ""
                          autocomplete="off" class="form-control" data-aw="4"/>
